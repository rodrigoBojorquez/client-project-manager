        ...
        <div className="bg-gray-100 grid w-[500px] h-[326px] place-items-center rounded-2xl px-5 shadow-1x2 mt-1">
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            ...
            <tr>
              ...
              <th style={{ textAlign: 'center', padding: '10px', borderBottom: '1px solid #ddd' }}>Cantidad</th>
              <th style={{ textAlign: 'right', padding: '10px', borderBottom: '1px solid #ddd' }}>Fecha de adicion</th>
            </tr>
          </thead>
          <tbody>
          <tr>
              <td style={{ textAlign: 'left', padding: '8px', borderBottom: '1px solid #ddd' }}>Salones</td>
              <td style={{ textAlign: 'center', padding: '8px', borderBottom: '1px solid #ddd' }}>5 unidades</td>
              <td style={{ textAlign: 'center', padding: '8px', borderBottom: '1px solid #ddd' }}>14-Ene-2024</td>
      ...
      <div className="flex flex-col items-center gap-3">
        <div className="bg-gray-100 grid  w-[398px] h-[285px] place-items-center rounded-2x1 px-5 shadow-1x2  mb-1">
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                <thead>
            <tr>
              <th style={{ textAlign: 'center', padding: '8px', borderBottom: '1px solid #ddd' }}>Nombre</th>
              <th style={{ textAlign: 'right', padding: '10px', borderBottom: '1px solid #ddd' }}>Fecha de edicion</th>
            </tr>
          </thead>
          <tbody>
          <tr>
              <td style={{ textAlign: 'left', padding: '8px', borderBottom: '1px solid #ddd' }}>proyecto</td>
              <td style={{ textAlign: 'right', padding: '8px', borderBottom: '1px solid #ddd' }}>14-Ene-2024</td>
            </tr>
            <tr>
              <td style={{ textAlign: 'left', padding: '8px', borderBottom: '1px solid #ddd' }}>Salones</td>
              <td style={{ textAlign: 'right', padding: '8px', borderBottom: '1px solid #ddd' }}>14-Ene-2024</td>
