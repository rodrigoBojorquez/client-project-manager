...
const SearchMatirials = ({ closeModalMatirials }) => {
    ...
    <div className="bg-black h-screen w-full flex flex-col items-center justify-center bg-opacity-65">
      <div className=" font-Nunito flex flex-col items-center bg-white w-[400px] h-[450px] rounded-lg">
        ...
        <div className="space-x-5">
          <button className="mt-5 text-lg text-[#1DAF90] hover:text-white font-semibold border-2 border-[#1DAF90] hover:bg-[#1DAF90] px-2 py-1 rounded-md">
            Agregar
          </button>
          <button
            type="button"
...
export default SearchMatirials;
